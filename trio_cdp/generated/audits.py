...
async def check_forms_issues() -> typing.List[GenericIssueDetails]:
    '''
    ...
    :returns: 
    '''
    session = get_session_context('audits.check_forms_issues')
    return await session.execute(cdp.audits.check_forms_issues())
