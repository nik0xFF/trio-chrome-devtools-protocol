...
async def set_show_window_controls_overlay(
    ...
    '''
    session = get_session_context('overlay.set_show_window_controls_overlay')
    return await session.execute(cdp.overlay.set_show_window_controls_overlay(window_controls_overlay_config))
