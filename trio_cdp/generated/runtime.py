...
async def call_function_on(
    ...
    return await session.execute(cdp.runtime.call_function_on(function_declaration, object_id, arguments, silent, return_by_value, generate_preview, user_gesture, await_promise, execution_context_id, object_group, throw_on_side_effect, unique_context_id, serialization_options))
...
async def evaluate(
    ...
    return await session.execute(cdp.runtime.evaluate(expression, object_group, include_command_line_api, silent, context_id, return_by_value, generate_preview, user_gesture, await_promise, throw_on_side_effect, timeout, disable_breaks, repl_mode, allow_unsafe_eval_blocked_by_csp, unique_context_id, serialization_options))
...
async def get_exception_details(
    ...
    **EXPERIMENTAL**
    ...
    :returns: 
    '''
    session = get_session_context('runtime.get_exception_details')
    return await session.execute(cdp.runtime.get_exception_details(error_object_id))
