...
async def add_privacy_sandbox_enrollment_override(
    ...
    :param url:
    '''
    session = get_session_context('browser.add_privacy_sandbox_enrollment_override')
    return await session.execute(cdp.browser.add_privacy_sandbox_enrollment_override(url))
